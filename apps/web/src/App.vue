...
import { Box, Collection, DataAnalysis, Document, FolderOpened, List, Location, Setting, Tickets } from "@element-plus/icons-vue";
...
const activeMenu = computed(() => {
  ...
  if (route.path.startsWith("/stocktakes")) return "/stocktakes";
  ...
  <el-container v-else class="app-shell">
    <el-aside width="232px" class="sidebar">
      ...
      <el-menu :default-active="activeMenu" router class="side-menu">
        ...
        <el-menu-item index="/stocktakes"><el-icon><List /></el-icon><span>盘点任务</span></el-menu-item>
