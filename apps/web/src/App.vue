...
import { Box, Checked, Collection, DataAnalysis, Document, FolderOpened, Location, Setting, Tickets } from "@element-plus/icons-vue";
...
const activeMenu = computed(() => {
  ...
  if (route.path.startsWith("/inventory-counts")) return "/inventory-counts";
  ...
  <el-container v-else class="app-shell">
    <el-aside width="232px" class="sidebar">
      ...
      <el-menu :default-active="activeMenu" router class="side-menu">
        ...
        <el-menu-item index="/inventory-counts"><el-icon><Checked /></el-icon><span>盘点</span></el-menu-item>
